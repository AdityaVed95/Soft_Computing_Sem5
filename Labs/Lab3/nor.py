...
def main():
    ...
    while(True):
        ...
        if should_we_break == 0:
            epoch_iterator += 1
            if epoch_iterator >= max_no_of_epochs:
                break
    ...
    if flag == 1:
        ...
        print("\n\nExact weights for getting zero error could not be computed in 5 epochs")
        print("\nThe final weight vector after ",max_no_of_epochs,"th epoch is : ",weight_vector)
        print("\nThe final weight of bias after ",max_no_of_epochs,"th epoch is : ",weight_bias,'\n\n')
