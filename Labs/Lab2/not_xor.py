...
def binary_step_fxn_for_last_neuron(net):    
    if net >= 0:
        return 1
...
def main():
    ...
    out3 = binary_step_fxn_for_last_neuron(net3)

    print("\nOutput of the neuron of 2nd layer i.e the output of NOT XOR neural network is : ",out3)
